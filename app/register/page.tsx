...
import { useRegisterUserMutation } from "@/lib/redux/features/auth/api";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.agreed) {
      toast.warn("You must agree to Terms & Privacy Policy!");
      return;
    }
    ...
    const payload =
      role === "DOCTOR"
        ? { ...basePayload, role, bmdcNumber: formData.bmdcNumber.trim() }
        : { ...basePayload, role };
