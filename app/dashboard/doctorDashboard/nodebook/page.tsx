...
const prescriptions = [
  { id: 1, patient: 'John Doe', date: '2025-06-15', notes: 'Take 1 tablet daily.' },
  { id: 2, patient: 'Jane Smith', date: '2025-06-12', notes: 'Apply cream twice daily.' },
  { id: 3, patient: 'Alice Johnson', date: '2025-06-10', notes: 'Inhale 2 puffs every 6 hours.' },
];
              ...
              <div className='w-full lg:w-3/4'>
                <div className='bg-white rounded-xl shadow-md px-6 pt-6 pb-6 text-center h-full flex flex-col relative'>
                  <div className='flex flex-row justify-between items-start'>
                    ...
                    <div className='block sm:hidden w-[220px] overflow-hidden'>
                      <div className='bg-[#42B3CE] text-white px-4 py-2' style={{ clipPath: 'polygon(10% 0%, 100% 0%, 100% 100%, 0% 100%)' }}>
                        <div className='text-right'>
                          <h2 className='text-sm font-bold uppercase tracking-wide'>Dr. Alexis Wolves</h2>
                    ...
                    <div className='hidden sm:block w-80 overflow-hidden absolute top-0 right-0 z-10'>
                      <div className='bg-[#42B3CE] text-white px-6 py-4' style={{ clipPath: 'polygon(10% 0%, 100% 0%, 100% 100%, 0% 100%)' }}>
                        <div className='text-right'>
                          <h2 className='text-lg font-bold uppercase tracking-wide'>Dr. Alexis Wolves</h2>
                  ...
                  <div className='hidden sm:grid grid-cols-2 gap-4 text-[18px] text-left mb-4 mt-20 text-[#5B5F5F]'>
                    ...
                    <p>
                      <strong className='pl-[88px]'>Phone Number: 0170000000</strong>
                    </p>
                    <p>
                      <strong>Patient Age: 25</strong>
                    </p>
                  ...
                  <div className='block sm:hidden'>
                    ...
                    <div className='grid grid-cols-2 gap-4 mb-6 border-2 border-[#06688E] rounded-lg p-4'>
                      ...
                      <div>
                        <p className='text-[18px] text-[#06688E] mb-3 border-dashed border-b-1 border-[#06688E] inline pb-1'>Risk Factory</p>
                        <ul className='list-none text-[14px] text-[#000] list-inside pt-2'>
                  ...
                  <div className='hidden sm:flex gap-4 text-left text-sm flex-grow'>
                    <div className='w-1/3 mt-10 mb-14'>
                      ...
                      <p className='text-[18px] text-[#06688E] font-bold mb-5 border-dashed border-b-1 border-[#06688E] inline pb-1 pt-3'>Risk Factory</p>
                  ...
                  <div className='mt-6 text-sm text-left'>
                    ...
                    <ul className='list-decimal list-inside space-y-1 pt-1.5 text-[14px] text-[#000]'>
                      <li>Always keep learning – Medicine never stops evolving, and neither should you.</li>
                      <li>Really listen to patients – They'll often tell you the diagnosis if you let them talk.</li>
                      <li>Protect your own health – You can't care for others if you're running on empty.</li>
                      <li>Document clearly and timely – Good notes help everyone clinically and legally.</li>
                      <li>Treat the whole team with respect – You're not an island.</li>
